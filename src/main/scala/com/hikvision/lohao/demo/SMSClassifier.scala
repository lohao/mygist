...
import com.hikvision.lohao.demo.test.SimpleIndexer
...
object SMSClassifier {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val ss = SparkSession.builder().appName("SMS").master("local").getOrCreate()
    ...
    val labelIndexer = new SimpleIndexer()
      .setInputCol("label")
