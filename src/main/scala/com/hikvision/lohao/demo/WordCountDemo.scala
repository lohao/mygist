...
//
//class WordCountDemo extends AlgorithmTemplate[SpecificRecord] {
//  /**SpecificRecord
//    * @param ss   传入的sparkSession
//    * @param args 传入的算法所需参数
//    * @return
//    */
//  override def run(ss: SparkSession, args: Array[String]): SpecificRecord = {
//
//    val textFile = ss.sparkContext.textFile(args.apply(0))
